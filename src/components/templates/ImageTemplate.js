...
import { FaImage, FaMagic, FaDownload, FaExclamationTriangle } from "react-icons/fa";
                    ...
                    <div className="relative border-2 border-dashed border-divider hover:border-primary/50 transition-colors rounded-lg h-32 flex flex-col items-center justify-center bg-bg-page/40 p-4">
                      {imgUrl ? (
                        <div className="w-full h-full relative group">
                          <img src={imgUrl} alt="Uploaded source" className="w-full h-full object-contain rounded" />
                          <button
                            type="button"
